...
export const I18N_RESOURCES = {
  ...
  "translation": {
    ...
    "nav": {
      ...
      "latencyTooltip": "遅延：ブラウザーと現在の入口ノードとの間の WebSocket ハートビートの往復時間です（直近数回の中央値）。入口ノードから対象ノードまでの区間は含みません。",
    ...
    "nodes": {
      ...
      "machine": {
        ...
        "domainAccess": {
          "label": "ドメインアクセスを許可",
          "description": "オフにすると、公開ドメイン（{{hosts}}）ではハブ／ノード間の通信のみを提供し、ウェブ画面と API は応答しなくなります。LAN の IP アドレスや localhost からのアクセスには影響しません。",
      ...
      "detail": {
        ...
        "domainAccessDescription": "オフにすると、設定した公開ドメインではハブ／ノード間の通信のみを提供し、ウェブ画面と API は利用できません。LAN の IP アドレスと localhost には影響しません。",
