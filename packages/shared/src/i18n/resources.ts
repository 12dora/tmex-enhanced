...
export const I18N_RESOURCES = {
  ...
  "translation": {
    ...
    "auth": {
      "login": {
        "title": "Sign in",
        "subtitle": "One password or one passkey signs you in to every reachable node.",
        "username": "Username",
        "password": "Password",
        "totp": "Authenticator code",
        "submit": "Sign in",
        "deriving": "Deriving keys…",
        "signingIn": "Signing in to nodes…",
      ...
      "errors": {
        "NO_SESSION_KEY": "Session key is gone, sign in again",
        "UNKNOWN_NODE": "Node is not in the mesh list",
        "NODE_PK_MISMATCH": "Node public key does not match the local record; sign-in aborted",
        "TOTP_REQUIRED": "Authenticator code required",
        "TOTP_INVALID": "Authenticator code is incorrect",
        "NETWORK_ERROR": "Network error",
        "RATE_LIMITED": "Too many attempts, try again later",
        "CHALLENGE_EXPIRED": "Login challenge expired, try again",
        "BAD_SIGNATURE": "Signature verification failed",
        "BAD_DELEGATION": "Delegation expired or invalid",
        "KEY_LOG_FORK": "Key log fork detected, check node state",
        "KEY_LOG_REJECTED": "Key log record rejected",
        "PASSKEY_CREDENTIAL_UNKNOWN": "No passkey is available for this entry",
        "LOGIN_FAILED": "Sign-in failed",
        "MALFORMED": "Malformed request",
        "UNKNOWN_USER": "No such user",
        "UNAUTHORIZED": "Not signed in",
        "CHALLENGE_CONSUMED": "Login challenge is no longer valid, try again",
        "CHALLENGE_MISMATCH": "Login challenge mismatch",
        "ENTRY_MISMATCH": "Entry node mismatch",
        "UID_MISMATCH": "User id mismatch",
        "TARGET_MISMATCH": "Target node mismatch",
        "PASSKEY_VERIFY_FAILED": "Passkey verification failed",
        "DELEGATION_EXPIRED": "Delegation expired, sign in again",
      ...
      "security": {
        ...
        "changePasswordWarning": "Changing the password rotates the root key: every passkey and TOTP secret is cleared on all devices and all sessions are revoked. You will have to register and sign in again.",
        ...
        "totpNote": "TOTP guards against remote password guessing and shoulder surfing; use a passkey for an independent second factor.",
        "totpPasskeyNote": "Passkey sign-in does not require TOTP.",
        "totpSet": "Set up TOTP",
        "totpReset": "Reset TOTP",
        "totpClear": "Turn off TOTP",
        "totpScanNow": "Scan this now with your authenticator — the secret is shown only once.",
        "passkeys": "Passkeys",
        "passkeyNote": "Each passkey is bound to the exact origin it was registered on; adding and removing writes a key-log record.",
    ...
    "nodes": {
      ...
      "machine": {
        ...
        "directActive": "Active",
        "directDisabled": "Turned off",
        "directInstall": "Install add-on",
        "directRemove": "Remove add-on",
        "directRemoveConfirm": {
          "title": "Remove the direct connection add-on?",
          "description": "The add-on files are deleted and direct connections stay off until you install it again. Sessions keep working through the hub relay.",
          "confirm": "Remove",
          "cancel": "Cancel"
        },
        ...
        "directFailed": "Could not change the direct connection add-on.",
  ...
  "translation": {
    ...
    "auth": {
      "login": {
        "title": "登录",
        "subtitle": "一次密码或一次 passkey，即可登录所有可达节点。",
        "username": "用户名",
        "password": "密码",
        "totp": "动态验证码",
        "submit": "登录",
      ...
      "errors": {
        "NO_SESSION_KEY": "会话密钥已失效，请重新登录",
        "UNKNOWN_NODE": "节点不在 mesh 列表中",
        "NODE_PK_MISMATCH": "节点公钥与本地记录不一致，已中止登录",
        "TOTP_REQUIRED": "需要动态验证码",
        "TOTP_INVALID": "动态验证码不正确",
        "NETWORK_ERROR": "网络错误",
        "RATE_LIMITED": "尝试过于频繁，请稍后再试",
        "CHALLENGE_EXPIRED": "登录挑战已过期，请重试",
        "BAD_SIGNATURE": "签名校验失败",
        "BAD_DELEGATION": "授权已过期或无效",
        "KEY_LOG_FORK": "密钥日志分叉，请检查各节点状态",
        "KEY_LOG_REJECTED": "密钥日志记录被拒绝",
        "PASSKEY_CREDENTIAL_UNKNOWN": "本入口没有可用的 passkey",
        "LOGIN_FAILED": "登录失败",
        "MALFORMED": "请求格式不正确",
        "UNKNOWN_USER": "用户不存在",
        "UNAUTHORIZED": "未登录",
        "CHALLENGE_CONSUMED": "登录挑战已失效，请重试",
        "CHALLENGE_MISMATCH": "登录挑战不匹配",
        "ENTRY_MISMATCH": "入口节点不匹配",
        "UID_MISMATCH": "用户标识不匹配",
        "TARGET_MISMATCH": "目标节点不匹配",
        "PASSKEY_VERIFY_FAILED": "passkey 校验失败",
      ...
      "security": {
        "title": "账号安全",
        "changePassword": "修改密码",
        "changePasswordWarning": "修改密码会轮换根密钥：所有设备上的 passkey 与 TOTP 将被清空，全部会话被注销，需要重新注册与登录。",
        ...
        "totp": "动态验证码（TOTP）",
        "totpNote": "TOTP 防的是远程猜密码与旁观；需要独立第二因素请用 passkey。",
        "totpPasskeyNote": "passkey 登录不需要 TOTP。",
        "totpSet": "设置 TOTP",
        "totpReset": "重设 TOTP",
        "totpClear": "关闭 TOTP",
        "totpScanNow": "请立即用认证器扫码，此密钥只显示这一次。",
        "passkeys": "Passkey",
        "passkeyNote": "每个 passkey 绑定注册时的精确 origin；注册与删除都会写入密钥日志。",
    ...
    "nodes": {
      ...
      "machine": {
        ...
        "directRemoveConfirm": {
          "title": "删除直连插件？",
          "description": "插件文件会被删除，直连将保持关闭，直到重新安装。会话仍可经 hub 中转。",
          "confirm": "删除",
          "cancel": "取消"
        },
        "directSwitch": "直连",
        ...
        "directErrorNotInstalled": "请先安装插件再开启直连。",
        "directErrorDetail": "{{base}}（{{detail}}）",
        "restartNow": "立即重启",
  ...
  "translation": {
    ...
    "auth": {
      "login": {
        "title": "ログイン",
        "subtitle": "パスワードまたは passkey を一度入力すれば、到達可能なすべてのノードにログインします。",
        "username": "ユーザー名",
        "password": "パスワード",
        "totp": "認証コード",
        "submit": "ログイン",
        "deriving": "鍵を導出しています…",
        "signingIn": "各ノードにログインしています…",
        "usePasskey": "passkey を使う",
      ...
      "errors": {
        "NO_SESSION_KEY": "セッション鍵が失効しました。再度ログインしてください",
        "UNKNOWN_NODE": "ノードが mesh 一覧にありません",
        "NODE_PK_MISMATCH": "ノードの公開鍵がローカル記録と一致しません。ログインを中止しました",
        "TOTP_REQUIRED": "認証コードが必要です",
        "TOTP_INVALID": "認証コードが正しくありません",
        "NETWORK_ERROR": "ネットワークエラー",
        "RATE_LIMITED": "試行が多すぎます。しばらくしてから再試行してください",
        "CHALLENGE_EXPIRED": "ログインチャレンジの有効期限が切れました",
        "BAD_SIGNATURE": "署名の検証に失敗しました",
        "BAD_DELEGATION": "委任が失効しているか無効です",
        "KEY_LOG_FORK": "鍵ログが分岐しています。各ノードの状態を確認してください",
        "KEY_LOG_REJECTED": "鍵ログレコードが拒否されました",
        "PASSKEY_CREDENTIAL_UNKNOWN": "このエントリで使える passkey がありません",
        "LOGIN_FAILED": "ログインに失敗しました",
        "MALFORMED": "リクエストの形式が不正です",
        "UNKNOWN_USER": "ユーザーが存在しません",
        "UNAUTHORIZED": "未ログインです",
        "CHALLENGE_CONSUMED": "ログインチャレンジは無効です。再試行してください",
        "CHALLENGE_MISMATCH": "ログインチャレンジが一致しません",
        "ENTRY_MISMATCH": "エントリノードが一致しません",
        "UID_MISMATCH": "ユーザー識別子が一致しません",
        "TARGET_MISMATCH": "対象ノードが一致しません",
        "PASSKEY_VERIFY_FAILED": "passkey の検証に失敗しました",
        "DELEGATION_EXPIRED": "委任の有効期限が切れました。再度ログインしてください",
      ...
      "security": {
        ...
        "changePasswordWarning": "パスワードを変更するとルート鍵がローテーションされ、すべての端末の passkey と TOTP が消去され、全セッションが失効します。再登録と再ログインが必要です。",
        "changePasswordDone": "パスワードを変更しました。各ノードで再ログインしてください",
        ...
        "totp": "認証アプリ（TOTP）",
        "totpNote": "TOTP はリモートからのパスワード推測や覗き見に対する防御です。独立した第二要素が必要な場合は passkey を使ってください。",
        "totpPasskeyNote": "passkey ログインに TOTP は不要です。",
        "totpSet": "TOTP を設定",
        "totpReset": "TOTP を再設定",
        "totpClear": "TOTP を無効化",
        "totpScanNow": "今すぐ認証アプリで読み取ってください。この秘密鍵は一度しか表示されません。",
        "passkeys": "Passkey",
        "passkeyNote": "各 passkey は登録時の origin に厳密に紐付きます。登録と削除は鍵ログに記録されます。",
    ...
    "nodes": {
      ...
      "machine": {
        ...
        "directRemoveConfirm": {
          ...
          "description": "アドオンのファイルを削除し、再インストールするまでダイレクト接続はオフのままです。セッションは hub 経由で継続します。",
          "confirm": "削除",
          "cancel": "キャンセル"
        },
        ...
        "directErrorDownloadFailed": "アドオンのダウンロードに失敗しました。",
