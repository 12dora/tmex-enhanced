...
export function dispatchUserInitiatedSelection(detail: UserInitiatedSelectionDetail): void {
  window.dispatchEvent(new CustomEvent(USER_INITIATED_SELECTION_EVENT, { detail }));
}
