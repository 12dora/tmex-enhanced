...
| 2 | B2-3/4/6/7/9 角色装配、接线、集成测试 | 完成 + 两轮修复（生产直连端到端、dc 会话校验、载体等级仲裁、关停协调、非空跑集成测试） | `b2-3`、`b2-4`、`b2-6`、`b2-7`、`b2-9` |
...
| 3 | F3-1/2/3 浏览器直连、bulk | 完成 + fix（RFC 8122 指纹、attempt 代际、四阶段屏障、rtcSession 绑定切换帧、bulk 超时/尺寸守卫） | `f3-*` |
...
见各 `*-result.md` 的测试摘要；最后一次全量：gateway 1802、shared 283、app 174、fe 206、ws-client 222、panels 217、api-client 85、stores 123，全部 0 fail；tsc 不高于基线；standalone e2e 94/7/1。
