...
| B2 node-a mesh lists hub isHub:true 915ff8f71d2f05508edd379fc7ba7401 | PASS |  |
...
| L2 transport=dc | PASS | {"reach":"lan","transport":"dc","direct_capable":true}; qdisc node-a[eth1]=qdisc netem 8014: root refcnt 11 limit 1000 delay 80ms rate 16Mbit; node-b[eth1]=qdisc netem 8015: root refcnt 11 limit 1000 delay 80ms rate 16Mbit |
...
| L5 SEQ_1..400 contiguous on entry stream | PASS | {"ok":true,"expectCount":400,"seqPrefix":"SEQ_","foundCount":400,"fromHistory":400,"fromOutput":191,"first":1,"last":400,"missing":[],"missingCount":0,"extra":[],"contiguous":true,"complete":true,"opened":true,"helloOk":true,"connected":true,"elapsedMs":19642}  |
| L6 transport returns to dc within 90s | PASS | {"reach":"lan","transport":"dc","direct_capable":true} |
| L7 8MiB sha256 over dc | FAIL | expect=2aad05ce41bf631c06e42a6f917adfd6441699ef8e62820cec498651066ca845 got= root_rc=1  |
| L8 8MiB sha256 with UDP drop (REST fallback) | PASS | relay_wait=1 sha256=2aad05ce41bf631c06e42a6f917adfd6441699ef8e62820cec498651066ca845 {"bytes":8388608,"headers":{"content-type":"application/octet-stream"},"bulkPath":"browser-only"} |
| D1 both rows direct_capable=true | PASS | {"reach":"relay","transport":"relay","direct_capable":true} |
| D2 transport=dc | FAIL | stayed relay/other path={"reach":"relay","transport":"relay","direct_capable":true}; node-a=[mesh][rtc] dial failed peer=915ff8f71d2f05508edd379fc7ba7401 reason=libdatachannel error while adding remote description: Unexpected remote answer description in signaling state stable fallback=ws-secure; hub=[mesh][rtc] dial failed peer=2507c80b8a5290dbb5478e08d7e444ec reason=datachannel open timeout fallback=ws-secure |
