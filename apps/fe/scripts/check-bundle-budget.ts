...
// 2.0.8 起首屏多了 SW 逃生通道 + 门禁探测（~1 KB gzip），上调 10 KB；2.2.0 起默认 locale core 也算首屏（modulepreload，~10 KB），再上调 20 KB；再涨先拆 chunk。
const BUDGET_GZIP_BYTES = { entryJs: 330_000, entryCss: 30_000 };
