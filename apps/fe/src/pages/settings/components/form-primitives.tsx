...
const NOTICE_TONE = {
  ...
  warning: 'warn',
  error: 'blocked',
} as const satisfies Record<NoticeTone, keyof typeof TONE_CLASS.notice>;
...
export function Notice({
  ...
  return (
    <div
      className={`flex items-start gap-1.5 rounded-lg p-2 text-xs ${TONE_CLASS.notice[NOTICE_TONE[tone]]}`}
      data-testid={testId}
    >
